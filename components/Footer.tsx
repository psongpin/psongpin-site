...
const FooterFrame = styled('footer', {
  ...
  backgroundColor: '$slateHighContrastText',
...
const Footer: React.FC = () => {
  ...
  return (
    <FooterFrame isVisible={isOpen}>
      <div>
        <FooterToggle onClick={onToggle}>
          <span>Social Links</span>
          {isOpen ? <ChevronDownIcon /> : <ChevronUpIcon />}
        </FooterToggle>
        <SocialLinks>
          <SocialLink
            href="https://twitter.com/psongpin"
            target="_blank"
            rel="noreferrer"
          >
            <svg
          ...
          <SocialLink
            href="https://www.facebook.com/psongpin"
            target="_blank"
            rel="noreferrer"
          >
            <svg
